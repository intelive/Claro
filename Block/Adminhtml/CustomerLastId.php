...
class CustomerLastId extends \Magento\Config\Block\System\Config\Form\Field
{
    protected $syncResourceModel;

    /**
     * CustomerLastId constructor.
    ...
    protected function _getElementHtml(AbstractElement $element) {
        return $this->syncResourceModel->getLastIdDate('customer');
    }
}